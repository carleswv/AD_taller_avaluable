...
modelo <- lm(Y ~ ., data = cuantitativas)
summary(modelo)  # Resumen del modelo
```


```{r}
# Calcular la función de score (predicciones)
predicciones <- predict(modelo, newdata = cuantitativas)

# Agregar la predicción al conjunto de datos original
cuantitativas$predicciones <- predicciones
